...
void matrix_Compute(){
	...
	#pragma omp parallel for num_threads(20) private(index_i, index_j, index_k) shared(matrix1, matrix2, matrix3) firstprivate(sum)
	for(index_i=0; index_i<200; index_i++){
		for(index_j= 0; index_j< COL; index_j++){
			for(index_k=0; index_k< LEN; index_k+=10){
				sum = sum+ tmp1[index_i][index_k] * matrix2[index_j][index_k]\
				 		 + tmp1[index_i][index_k+1] * matrix2[index_j][index_k+1] \
						 + tmp1[index_i][index_k+2] * matrix2[index_j][index_k+2] \
						 + tmp1[index_i][index_k+3] * matrix2[index_j][index_k+3] \
						 + tmp1[index_i][index_k+4] * matrix2[index_j][index_k+4] \
						 + tmp1[index_i][index_k+5] * matrix2[index_j][index_k+5] \
						 + tmp1[index_i][index_k+6] * matrix2[index_j][index_k+6] \
						 + tmp1[index_i][index_k+7] * matrix2[index_j][index_k+7] \
						 + tmp1[index_i][index_k+8] * matrix2[index_j][index_k+8] \
						 + tmp1[index_i][index_k+9] * matrix2[index_j][index_k+9]; 			
			}
